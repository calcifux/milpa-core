...
from milpa.Core.Database.Migrations import run_downgrade, run_upgrade
...
def db_fresh(force: bool = typer.Option(False, "--force", help="No pedir confirmación (CI/scripts).")) -> None:
    ...
    from milpa.Core.Console.Commands.SeedCommands import db_seed  # lazy: evita ciclos de import
