...
`tmp_path` y limpiamos sys.path/sys.modules y el registro en teardown para no
...
from milpa.Core.Cron import cron_task, every_minute, reset_cron_registry, to_crontab
from milpa.Core.Registry import collect_beat_schedule
