"""Tests de milpa.lazy: import perezoso (difiere hasta el primer uso)."""
...
from milpa import lazy as lazy_mod
...
def test_from_milpa_lazy_import_works() -> None:
    """`from milpa.lazy import X` (PEP 562) devuelve el módulo X perezoso y usable."""
    from milpa.lazy import json  # pasa por __getattr__
