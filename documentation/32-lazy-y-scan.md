...
El auto-discovery de milpa importa **todos** los módulos de tu app al arrancar (para registrar
...
- Genérico para **cualquier** lib: `from milpa.lazy import pandas`, `numpy`, etc.
...
|---|---|
| `lazy` | libs pesadas (openpyxl, pandas, numpy, torch...) importadas **eager** — candidatas a `milpa.lazy`. Acredita ✓ las que ya están diferidas. |
